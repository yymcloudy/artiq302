...
class BaseSequence_Rabi(TrapEnvScan):
    ...
    def build_fragment(self):
        ...
        self.setattr_param("detection_frequency", FloatParam, "Detection frequency", default=138.0*MHz, unit="MHz")
    ...
    def prepare(self):
        ...
        self.mw_tunefreq.set(frequency=self.mw_freq.get(), phase=0.0,amplitude = self.mw_amplitude.get())

...
class NVMicrowave_Ramsey_Switch(Trap302EnvScan):
    """NVMicrowave_Ramsey_switch"""
    ...
    def run_once(self):
        ...
        delay(self.ramsey_delay.get())  # wait for the next Ramsey pulse
        self.nv_mw_switch.pulse(self.nv_microwave_duration.get())
...
nv_microwave_ramsey_switch = make_fragment_scan_exp(NVMicrowave_Ramsey_Switch) 
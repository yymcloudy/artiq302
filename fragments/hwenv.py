...
class HardwareEnvScan(ExpFragment):
    """hardwareenv_scan"""
    def build_fragment(self):
        ...
        print("HardwareEnvScan Build Done")

    def host_setup(self):
        self._init_devices()

    def prepare(self):
        self.version = "hardware_env_scan_v1.0"
        print(self.version)
    ...
    def _init_devices(self):
        ...
        print("HardwareEnvScan Device Init Done")
    ...
    def set_idle(self):
        ...
        self.ttl15.off()
        delay(100*ms)
        print("HardwareEnvScan Set_Idle Done")
    ...
    def run_once(self):
        ...
        print("HardwareEnvScan Run_Once Done")

# Create scan experiment
HardwareEnvScanExp = make_fragment_scan_exp(HardwareEnvScan)

class HardwareEnv(EnvExperiment):
    """hardwareenv"""
